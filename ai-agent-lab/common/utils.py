...
# 작업별 최적 모델 라우팅
MODEL_ROUTING = {
    "loan_review":       MODELS["groq-large"],
    "large_loan":        MODELS["groq-large"],
    "investment_report": MODELS["groq-large"],
    "customer_qa":       MODELS["groq-large"],
    "report_draft":      MODELS["groq-large"],
    "fds_check":         MODELS["groq-fast"],
    "simple_faq":        MODELS["groq-fast"],
    "classification":    MODELS["groq-fast"],
}
